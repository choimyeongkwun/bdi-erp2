...
<form action="<%=rPath%>/views/userInfo/userUpdateOK.jsp" onsubmit="return checkVal()">
	<fieldset>
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>유저설명</th>
				<td><textarea type="text" name="uiDesc"><%=uiDesc%></textarea></td>
			</tr>
			<tr>
				<th>나이</th>
				<td><input type="number" name="uiAge" min="1" max="123" value="<%=uiAge%>"></td>
			</tr>
			<tr>
				<th>부서번호</th>
...
<script>
	...
	function checkVal(){
		...
		if(obj.value.lenght>=2000){
			alert("유저설명은 2000자 이하로 해주세요");
			obj.focus();
			return false;
		}
		return true;
